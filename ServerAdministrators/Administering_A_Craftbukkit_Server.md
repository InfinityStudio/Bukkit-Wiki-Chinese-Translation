...
## 目录
  ...
  * 1 [第 1 部分: 开天辟地](#第 1 部分: 开天辟地)
    * 1.1 [“纯净”服务器和“插件”服务器](#“纯净”服务器和“插件”服务器)
    * 1.2 [Bukkit项目](#Bukkit项目)
    * 1.3 [租用服务器的套餐](#租用服务器的套餐)
    * 1.4 [CraftBukkit 还是 Bukkit？](#CraftBukkit 还是 Bukkit？)
    * 1.5 [选择你的操作系统，存储设备大小和内存大小](#选择你的操作系统，存储设备大小和内存大小)
    * 1.6 [价格](#价格)
  * 2 [第 2 部分: 玩家社群](#第 2 部分: 玩家社群)
    * 2.1 [作为服务器管理员，你应该如何对待自己的玩家](#作为服务器管理员，你应该如何对待自己的玩家)
      * 2.1.1 [你应该怎样做](#你应该怎样做)
    * 2.2 [招收管理员](#招收管理员)
      * 2.2.1 [申请系统](#申请系统)
        * 2.2.1.1 [审核](#审核)
      * 2.2.2 [观察你的玩家](#观察你的玩家)
    * 2.3 [关于封禁](#关于封禁)
      * 2.3.1 [什么是对玩家负责任的封禁。不负责任的封禁对玩家社群有什么影响？](#什么是对玩家负责任的封禁。不负责任的封禁对玩家社群有什么影响？)
      * 2.3.2 [仁慈和严厉](#仁慈和严厉)
      * 2.3.3 [全局封禁 - 你的志高责任](#全局封禁 - 你的志高责任)
    * 2.4 [让你的玩家社群真正参与进服务器中](#让你的玩家社群真正参与进服务器中)
    * 2.5 [选择你真正所需的插件](#选择你真正所需的插件)
      * 2.5.1 [开发插件](#开发插件)
    * 2.6 [日程编排](#日程编排)
    * 2.7 [做好最坏的准备](#做好最坏的准备)
    * 2.8 [当你的服务器暂时关闭的时候](#当你的服务器暂时关闭的时候)
    * 2.9 [“这或许是你的服务器，但它是为玩家而生的”](#“这或许是你的服务器，但它是为玩家而生的”)
  * 3 [第 3 部分: 服务器运维](#第 3 部分: 服务器运维)
    * 3.1 [救命！Minecraft升级了！](#救命！Minecraft升级了！)
    * 3.2 [我的插件升级了吗？我怎么判断呢？](#我的插件升级了吗？我怎么判断呢？)
    * 3.3 [升级你的插件](#升级你的插件)
    * 3.4 [向别人问问题](#向别人问问题)
